...
/**
 * ApiFieldSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiFieldSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api.FieldSchema';
    ...
    */
     ...
     * Sets operators
     *
     * @param string[]|null $operators List of supported operators for this field
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of the field (e.g., string, int)
     *
     * @return self
     */

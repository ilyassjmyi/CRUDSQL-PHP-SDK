...
/**
 * QueryQueryFilter Class Doc Comment
 *
 * @category Class
 ...
 */
class QueryQueryFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'query.QueryFilter';
    ...
    */
     ...
     * Sets expressions
     *
     * @param object[]|null $expressions @Description Array of expressions to filter entities @Description Each expression can be a FieldExpression, LogicalExpression, or RelationshipExpression
     *
     * @return self
     */

...
/**
 * ApiRelationshipSchema Class Doc Comment
 *
 * @category Class
 ...
 */
class ApiRelationshipSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api.RelationshipSchema';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of the relationship
     *
     * @return self
     */
     ...
     * Sets related_model
     *
     * @param string|null $related_model Name of the related model
     *
     * @return self
     */
    public function setRelatedModel($related_model)
    {
        if (is_null($related_model)) {
            throw new \InvalidArgumentException('non-nullable related_model cannot be null');
        }
     ...
     * Sets type
     *
     * @param string|null $type Type of relationship (hasOne, hasMany)
     *
     * @return self
     */
